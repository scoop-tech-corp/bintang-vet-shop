...
<div class="box box-info" id="barang-pet-care-app">
  <div class="box-header ">
    <h3 class="box-title">Barang Pet Care</h3>
  ...
  @component('gudang.pet-care.modal-pet-care') @endcomponent
  @component('gudang.pet-care.upload-pet-care') @endcomponent
...
@section('script-content')
  ...
  <script src="{{ asset('main/js/gudang/pet-care/pet-care.js') }}"></script>
  <script src="{{ asset('bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js') }}"></script>
@endsection
@section('css-content')
  <link rel="stylesheet" type='text/css' href="{{ asset('main/css/pet-care.css') }}">

<div class="modal fade" id="modal-barang-pet-care">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="form-barang-pet-care">
					<div class="box-body">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-primary" id="btnSubmitBarangPetCare">Simpan</button>
			</div>
		</div>
		<!-- /.modal-content -->
	</div>

...
<div class="box box-info" id="barang-vitamin-app">
  <div class="box-header ">
    <h3 class="box-title">Barang Vitamin</h3>
  ...
  @component('gudang.vitamin.modal-vitamin') @endcomponent
  @component('gudang.vitamin.upload-vitamin') @endcomponent
...
@section('script-content')
  ...
  <script src="{{ asset('main/js/gudang/vitamin/vitamin.js') }}"></script>
@endsection
@section('css-content')
  <link rel="stylesheet" type='text/css' href="{{ asset('main/css/vitamin.css') }}">

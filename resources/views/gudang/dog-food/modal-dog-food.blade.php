<div class="modal fade" id="modal-barang-dog-food">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="form-barang-dog-food">
					<div class="box-body">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-primary" id="btnSubmitBarangDogFood">Simpan</button>
			</div>
		</div>
		<!-- /.modal-content -->
	</div>

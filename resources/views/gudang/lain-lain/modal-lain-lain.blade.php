<div class="modal fade" id="modal-barang-lain-lain">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="form-barang-lain-lain">
					<div class="box-body">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-primary" id="btnSubmitBarangLainlain">Simpan</button>
			</div>
		</div>
		<!-- /.modal-content -->
	</div>

...
<div class="box box-info" id="barang-cat-food-app">
  <div class="box-header ">
    <h3 class="box-title">Barang Cat Food</h3>
  ...
  @component('gudang.cat-food.modal-cat-food') @endcomponent
  @component('gudang.cat-food.upload-cat-food') @endcomponent
...
@section('script-content')
  ...
  <script src="{{ asset('main/js/gudang/cat-food/cat-food.js') }}"></script>
  <script src="{{ asset('bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js') }}"></script>
@endsection
@section('css-content')
  <link rel="stylesheet" type='text/css' href="{{ asset('main/css/cat-food.css') }}">

...
<div class="box box-info" id="barang-animal-food-app">
  <div class="box-header ">
    <h3 class="box-title">Barang Animal Food</h3>
  ...
  @component('gudang.animal-food.modal-animal-food') @endcomponent
  @component('gudang.animal-food.upload-animal-food') @endcomponent
...
@section('script-content')
  ...
  <script src="{{ asset('main/js/gudang/animal-food/animal-food.js') }}"></script>
@endsection
@section('css-content')
  <link rel="stylesheet" type='text/css' href="{{ asset('main/css/animal-food.css') }}">

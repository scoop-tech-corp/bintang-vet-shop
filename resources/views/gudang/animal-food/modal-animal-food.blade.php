<div class="modal fade" id="modal-barang-animal-food">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="form-barang-animal-food">
					<div class="box-body">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-primary" id="btnSubmitBarangAnimalFood">Simpan</button>
			</div>
		</div>
		<!-- /.modal-content -->
	</div>

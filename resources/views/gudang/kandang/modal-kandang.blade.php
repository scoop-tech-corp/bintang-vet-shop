<div class="modal fade" id="modal-barang-kandang">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="form-barang-kandang">
					<div class="box-body">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-primary" id="btnSubmitBarangKandang">Simpan</button>
			</div>
		</div>
		<!-- /.modal-content -->
	</div>

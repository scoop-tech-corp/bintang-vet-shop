...
<div class="box box-info" id="barang-kandang-app">
  <div class="box-header ">
    <h3 class="box-title">Barang Kandang</h3>
  ...
  @component('gudang.kandang.modal-kandang') @endcomponent
  @component('gudang.kandang.upload-kandang') @endcomponent
...
@section('script-content')
  ...
  <script src="{{ asset('main/js/gudang/kandang/kandang.js') }}"></script>
  <script src="{{ asset('bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js') }}"></script>
@endsection
@section('css-content')
  <link rel="stylesheet" type='text/css' href="{{ asset('main/css/kandang.css') }}">

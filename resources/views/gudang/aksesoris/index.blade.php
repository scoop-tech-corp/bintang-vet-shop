...
<div class="box box-info" id="barang-aksesoris-app">
  <div class="box-header ">
    <h3 class="box-title">Barang Aksesoris</h3>
  ...
  @component('gudang.aksesoris.modal-aksesoris') @endcomponent
  @component('gudang.aksesoris.upload-aksesoris') @endcomponent

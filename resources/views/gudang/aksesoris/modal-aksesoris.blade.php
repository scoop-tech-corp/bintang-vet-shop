<div class="modal fade" id="modal-barang-aksesoris">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="form-barang-aksesoris">
					<div class="box-body">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-primary" id="btnSubmitBarangAksesoris">Simpan</button>
			</div>
		</div>
		<!-- /.modal-content -->
	</div>

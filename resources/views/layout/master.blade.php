...
<head>
  ...
  <title>Stella Vet Shop | Dashboard</title>
    ...
    <input class="baseUrl" type="hidden" value="{{ url('/') }}"/>
		<header class="main-header">
			...
			<a href="{{ url('/') }}" class="logo">
				...
				<span class="logo-mini"><b>S</b>VS</span>
				<!-- logo for regular state and mobile devices -->
				<span class="logo-lg"><b>STELLA</b> <b>VET</b> SHOP</span>
			</a>
		...
		<footer class="main-footer">
			...
			<strong>Copyright &copy; <script>document.write(new Date().getFullYear())</script> <a href="{{ url('/') }}">Stella Vet Shop</a></strong> | Powered by Scoop Tech
		</footer>

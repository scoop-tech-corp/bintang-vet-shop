...
<head>
  ...
  <title>Bintang Vet Clinic | Dashboard</title>
...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <input class="baseUrl" type="hidden" value="{{ url('/') }}"/>
		...
		<footer class="main-footer">
			...
			<strong>Copyright &copy; <script>document.write(new Date().getFullYear())</script> <a href="{{ url('/') }}">Bintang Vet Clinic</a></strong> | Powered by Scoop Tech
		</footer>

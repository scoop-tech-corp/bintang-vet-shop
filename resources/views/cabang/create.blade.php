            ...
            <div class="card-body">
                ...
                <form method="post" action="/cabang/store">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="KodeCabang" class="form-control" placeholder="Kode Cabang ..">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="NamaCabang" class="form-control" placeholder="Nama Cabang .."></textarea>

$(document).ready(function() {
  ...
  $('.downloadExcel').click(function() {
    $.ajax({
			...
			type    : 'GET',
      data	  : { orderby: paramUrlSetup.orderby, column: paramUrlSetup.column, keyword: paramUrlSetup.keyword, branch_id: paramUrlSetup.branchId, category: 'Animal Food' },
  ...
  $('#btnSubmitBarangAnimalFood').click(function() {
    if (modalState == 'add') {
      ...
      fd.append('category', 'Animal Food');
          ...
          $.each(data, function(idx, v) {
            ...
            + `<td>
                ${
                  ...
                  : `${(v.image)
                      ? `<a class="image-list-animal-food" href="${v.image}"><img src="${v.image}" width="50" height="50"></a>`

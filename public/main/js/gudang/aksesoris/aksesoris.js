$(document).ready(function() {
  ...
  $('.downloadExcel').click(function() {
    $.ajax({
			...
			type    : 'GET',
      data	  : { orderby: paramUrlSetup.orderby, column: paramUrlSetup.column, keyword: paramUrlSetup.keyword, branch_id: paramUrlSetup.branchId, category: 'accessories' },
  ...
  $('#btnSubmitBarangAksesoris').click(function() {
    if (modalState == 'add') {
      ...
      fd.append('category', 'accessories');
        ...
        if(data.length) {
          $.each(data, function(idx, v) {
            listAksesoris += `<tr>`
              ...
              + `<td>
                  ${(v.image) ? `<a class="image-list-aksesoris" href="${v.image}"><img src="${v.image}" width="50" height="50"></a>` 
